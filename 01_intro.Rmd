...
Diese Woche dreht sich alles rund ums Kennenlernen und Aufwärmen. Unten findet Ihr alle wichtigen Informationen zum Kurs nochmal in Schriftform - inklusiver aller wichtigen Links zu [Slack](https://join.slack.com/share/enQtNDE3NTM5MjU2MzU4NC0xZTBiOTQwYzZkYzhiNjI1M2IwOTA0NTY2NjI5MGM5YWQ1Y2U3ODdiMzhjZTA4NWJjZTczZTNiZDg1OGFmODU4){target="_blank"} und der Live-Session am Freitag auf [Zoom](https://us02web.zoom.us/j/88057998873?pwd=L21Ib3NUMFlicnhCa3FabWpPOUdoUT09&from=addon#success){target="_blank"}. Lest Euch die Informationen gut durch. Falls es dazu Fragen gibt, können wir diese am **Freitag, den 7.10.22, um 12 Uhr** nach einer kleinen Vorstellungsrunde klären. Dazu arbeiten wir gemeinsam auf [Mural](https://app.mural.co/invitation/room/1639481285632?code=85530a55216f463eb45c9e17becefc52&sender=ninah9635){target="_blank"}. Gerne könnt Ihr Euch dort schon eintragen. Wie jede Woche wird im Anschluss an unseren Live-Termin das nächste Kapitel freigeschaltet. 
...
### Eckdaten 
- 7.10.22 - 23.12.22, Aufwand: 2-4h/Woche
- Blended-Learning mit Lernplattform
- Jeden Freitag live von 12 - 13 Uhr  [(Klick hier!)](https://us02web.zoom.us/j/88057998873?pwd=L21Ib3NUMFlicnhCa3FabWpPOUdoUT09&from=addon#success){target="_blank"}
- Mit und von Datenprofis

### Wochenplan
#### Woche 1 (Livetermin 07.10.22): Kick-Off!
Wir stellen uns, Ihr Euch und wir die **Kursmodalitäten** vor.

#### Woche 2 (Livetermin 14.10.22): Daten- und Leuchtturmprojekte der Zivilgesellschaft
Wir präsentieren **Anwendungsbeispiele von Datenprojekten** aus unserem Arbeitsalltag und der Zivilgesellschaft, um einen Ausblick auf Mögliches zu geben. Außerdem verrraten wir Tipps & Tricks, die es bei Datenprojekten zu beachten gilt. Ihr entwickelt erste Ideen für Euer eigenes Projekt.

#### Woche 3 (Livetermin 21.10.22): Datenschutz & -Ethik für Anfänger:innen
...
#### Woche 4 (Livetermin 28.10.22): Einführung in RStudio
...
#### Woche 5 (Livetermin 04.11.22): Daten mit R verstehen
...
#### Woche 6 (Livetermin 11.11.22): Datenimport
...
#### Woche 7 (Livetermin 18.11.22): Datentransformation
...
#### Woche 8 (Livetermin 25.11.22): Datenvisualiserung
...
#### Woche 9 (Livetermin 02.12.22): Grundlagen der Statistik
...
#### Woche 10 (Livetermin 09.12.22): Reports
...
#### Woche 11 (Livetermin 16.12.22: Reportautomatisierung
...
#### Woche 12 (Livetermin 23.12.22): Interaktive Visualisierung
...
- Zusätzlich könnt Ihr [**1:1 Sprechstunden**](https://calendly.com/correlaid-frie/datensprechstunde){target="_blank"} mit den Datenprofis buchen, um parallel an Eurem eigenen Projekt zu arbeiten (entweder direkt in der Sprechstunde oder per Mail an Nina)
...
```
  ...
  <div class="col-sm-10">
  <h4 style="padding-left:90px;">Zoé Wolter [Projektassistenz]</h4>
  <p style="margin-left: 90px;">
[Zoé]((mailto:zoe.w@correlaid.org)) ist seit 2018 bei CorrelAid aktiv und arbeitet nun als Werkstudentin bei uns. Aktuell studiert sie im Master in Konstanz "Social and Economic Data Science" und unterstützt Euch als Mentorin für R.
  </p>
  </div>
</div>
