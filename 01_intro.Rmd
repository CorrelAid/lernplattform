...
- Zusätzlich könnt Ihr **1:1 Sprechstunden** mit den Datenprofis buchen, um parallel an Eurem eigenen Projekt zu arbeiten (entweder direkt in der Sprechstunde oder per Nachricht oder Mail an Zoé)
- Außerdem wird Euer Lernduo auch eine:r Tutor:in zugeordnet, sodass Ihr eine:n Mentor:in an Eurer Seite habt. Meldet Euch nach der ersten Live-Session einfach einmal direkt bei Euerer:m Mentor:in!
...
<!--   <div class="col-sm-10"> -->
<!--   <h4 style="padding-left:90px;">Nina Hauser [Projektleitung]</h4> -->
<!--   <p style="margin-left: 90px;"> -->
<!-- [Nina](nina.h@correlaid.org) ist ausgebildete Datenanalystin. Seit 2020 entwickelt -->
<!-- sie für CorrelAid e.V. technische Frameworks und  -->
<!-- Bildungsmaterialien im Bereich Daten. Um die Nutzerzentrierung unserer  -->
<!-- Angebote zu sichern, nutzt sie Techniken des Design  -->
<!-- Thinking. Mit „R Lernen –  -->
...
```
  ...
  <p style="margin-left: 90px;">
[Lisa]((mailto:lisa.r@correlaid.org))
  </p>
  </div>
</div>
...
```
  ...
  <p style="margin-left: 90px;">
[Lisa]((mailto:sylvi.r@correlaid.org))
  </p>
  </div>
</div>
...
```
  ...
  <p style="margin-left: 90px;">
[Cosima]((mailto:education@correlaid.org))
  </p>
  </div>
</div>
...
```
  ...
  <p style="margin-left: 90px;">
[Phil]((mailto:phil.b@correlaid.org))
  </p>
  </div>
</div>
