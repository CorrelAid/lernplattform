...
Am Ende des Kurses könnt Ihr zwei Arten von Datenprodukten erstellen: Einen **reproduzierbaren Bericht**, der automatisch für mehrere Instanzen erstellt wird, und eine **interaktive Web Applikation** zur explorativen Erkundung von Daten. Damit Euch zwischendurch nicht die Puste ausgeht, ist jetzt ein guter Zeitpunkt um die folgenden beiden Fragen zu beantworten:
...
#### Woche 5 (Livetermin 29.04.22): Erste Analysen in R
...
#### Woche 7 (Livetermin 13.05.22): Datenbereinigung
