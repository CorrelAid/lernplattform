...
Diese Woche dreht sich alles rund ums Kennenlernen und Aufwärmen. Unten findet Ihr alle wichtigen Informationen zum Kurs nochmal in Schriftform - inklusiver aller wichtigen Links zu [Slack](https://join.slack.com/share/enQtMzc1MjM0NjY1ODM3NC0zYTZhNjUxNmJlMjEyZmIyMTY2MDBjNmQ1ZDU4OTFlZWIzMmJlZDAwYzQzZTI0MTAzZjU4M2UzOWY2YzM0NmI3){target="_blank"} und der Live-Session am Freitag auf [Zoom](https://us02web.zoom.us/j/81174653624?pwd=4HDec1uFgB5ql3JC38sujzAc6mQdPU.1&from=addon){target="_blank"}. Lest Euch die Informationen gut durch. Falls es dazu Fragen gibt, können wir diese am **Freitag, den 8.7.22 um 12 Uhr**, nach einer kleinen Vorstellungsrunde klären. Dazu arbeiten wir gemeinsam auf [Mural](https://app.mural.co/invitation/room/1639481268810?code=0d908cb22792410d97948f86822df4ea&sender=ninah9635){target="_blank"}. Gerne könnt Ihr Euch dort schon eintragen. Wie jede Woche wird im Anschluss an unseren Live-Termin das nächste Kapitel freigeschaltet. 
...
### Eckdaten 
- 8.7.22 - 23.9.22, Aufwand: 2-4h/Woche
- Blended-Learning mit Lernplattform
- Jeden Freitag live von 12 - 13 Uhr  [(Klick hier!)](https://us02web.zoom.us/j/81174653624?pwd=4HDec1uFgB5ql3JC38sujzAc6mQdPU.1&from=addon){target="_blank"}
- Mit und von Datenprofis

### Wochenplan
#### Woche 1 (Livetermin 08.07.22): Kick-Off!
Wir stellen uns, Ihr Euch und wir die **Kursmodalitäten** vor.

#### Woche 2 (Livetermin 15.07.22): Daten- und Leuchtturmprojekte der Zivilgesellschaft
...
#### Woche 3 (Livetermin 22.07.22): Datenschutz & -Ethik für Anfänger:innen
...
#### Woche 4 (Livetermin 29.07.22): Einführung in RStudio
...
#### Woche 5 (Livetermin 05.08.22): Daten mit R verstehen
...
#### Woche 6 (Livetermin 12.08.22): Datenimport
...
#### Woche 7 (Livetermin 19.08.22): Datentransformation
...
#### Woche 8 (Livetermin 26.08.22): Datenvisualiserung
...
#### Woche 9 (Livetermin 02.09.22): Grundlagen der Statistik
...
#### Woche 10 (Livetermin 09.09.22): Reports
...
#### Woche 11 (Livetermin 16.09.22: Reportautomatisierung
...
#### Woche 12 (Livetermin 23.09.22): Interaktive Visualisierung
...
```
  ...
  <div class="col-sm-10">
  <h4 style="padding-left:90px;">Philipp Bosch [Vermittlung von
 Expertise]</h4>
  <p style="margin-left: 90px;">

[Phil](mailto:phil.b@correlaid.org) stärkt als ausgebildeter Datenwissenschaftler die Data
...
Partnerschaften akquiriert. Im Netzwerk kennt er (fast) jeden und kann Euch Expert:innen aus unserem Netzwerk vermitteln!
  </p>
  </div>
</div>
