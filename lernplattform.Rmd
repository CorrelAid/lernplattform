...
plastics_prep <- plastics %>%
  ...
  dplyr::mutate(
    country = str_replace(country, "United Kingdom of Great Britain & Northern Ireland", "United Kingdom"),
...
community <- plastics_prep %>%
  dplyr::select(country, year, num_events, volunteers, grand_total, continent, countrycode) %>%
