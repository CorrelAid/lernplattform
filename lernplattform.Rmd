...
```{r results='asis'}
out <- knitr::knit_child("09_AutomatisierteReports.Rmd", quiet = TRUE)
cat(out, sep = '')
```

## Datenvisualisierung
```{r results='asis'}
out <- knitr::knit_child("10_Shiny1.Rmd", quiet = TRUE)
cat(out, sep = '')
```

## Interaktive Visualisierungen
```{r results='asis'}
out <- knitr::knit_child("11_Shiny2.Rmd", quiet = TRUE)
cat(out, sep = '')
```
