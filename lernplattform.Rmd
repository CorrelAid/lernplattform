...
community <- rio::import(paste0(here::here(),'/daten/bffp2019_community_by_country.csv'))

### Audit Datensatz laden
audit <- rio::import(paste0(here::here(),'/daten/bffp2019_audit_by_country_and_company.csv'))
