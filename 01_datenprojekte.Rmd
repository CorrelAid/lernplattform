...
### Quiz
Derzeit sind 20 Data4Good-Projekte bei CorrelAid e.V. aktiv. Aber wie viele Projekte hat CorrelAid e.V. bereits abgeschlossen (Stand 2021)? Ersetzt in dem Codebeispiel unten den Wert für die Variable "abgeschlossene_projekte" mit der richtigen Zahl 39 und führt den Code aus.
...
glue("CorrelAid e.V. hat (Stand: {datum}) {abgeschlossene_projekte} Projekte durchgeführt. {aktive_projekte} sind noch aktiv.")
```
