...
plastics19_by_country_and_company %>% rio::export(here::here("daten/plastics19_long.rds"))
```


```{r export-csv}
write.csv(community19_by_country, here::here("daten/community19_by_country.csv"), row.names = FALSE)
write.csv(plastics19_by_country_and_company, here::here("daten/plastics19_by_country_and_company.csv"), row.names = FALSE)
```
