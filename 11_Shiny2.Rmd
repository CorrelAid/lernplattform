...
Wenn Ihr die App ausprobieren möchtet, könnt Ihr das noch einmal [**hier**](https://cosima-meyer.shinyapps.io/break_free_from_plastic/){target="_blank"} machen.
...
Da wir auf dieser Plattform keine Shiny-App direkt programmieren können, haben wir Euch hier die Code-Snippets zusammengestellt und erklären Euch die einzelnen Schritte. Um die Shiny-App während der Sitzung mitzubauen, haben wir Euch die Datei `app.R` vorbereitet. Die Datei könnt Ihr Euch wie einen "Lückentext" vorstellen, an dem Ihr an den entsprechenden Stellen den Code einfügt und abschließend Eure Shiny-App lokal laufen lasst! 

*Anmerkung: Solltet Ihr nicht weiterkommen, haben wir auch eine `app_loesung.R`-Datei für Euch vorbereitet.*
