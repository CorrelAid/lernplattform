...
![](daten/abbildungen/shiny_step1.png){#id .class width=50% height=50%}
...
![](daten/abbildungen/shiny_step2.png){#id .class width=50% height=50%}
...
![](daten/abbildungen/shinyapps1.png){#id .class width=50% height=50%}

Dort klickt Ihr auf Euer Benutzerkonto (rechts oben) und dann auf "Tokens" und gelangt zu folgendem Fenster:

![](daten/abbildungen/shinyapps2.png){#id .class width=50% height=50%}
...
![](daten/abbildungen/shinyapps3.png){#id .class width=50% height=50%}
