...
<<<<<<< HEAD
1. Wählt Euch eine Visualisierung (z.B. mit `ggplot2` oder aber auch mit `echarts4r`)  mit euren Daten aus (idealerweise habt Ihr schon Code, den Ihr jetzt einfach wieder benutzen könnt - zum Beispiel aus der letzten Woche. Wenn Ihr keinen Code bereit habt, haben wir zwei mögliche Visualisierungen (eine Punktewolke und eine Karte) für Euch vorbereitet, die Ihr nutzen könnt und damit die folgenden Schritte üben könnt.)
=======
...
>>>>>>> b738bbd64e8881c324b40cadc5e10e5149726ec7
