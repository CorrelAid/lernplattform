...
| **Was möchtet Ihr darstellen?**                                       | **Befehl in R**                     |
|-------------------------------------------------------------------|---------------------------------|
...
Aber eins nach dem anderen. Fangen wir zuerst mit der linken Seitenleiste an. In der Datei `app.R` habt ihr unter `# 2. Aufgabe` wieder eine detaillierte Anleitung, was ihr machen müsst, um die App zu füllen. 

```{r ui_exercise, exercise=TRUE}
# UI ----------------------------------------------------------------------
...
Wir vernachlässigen in diesem Schritt zunächst das `mainPanel()` - das kommt gleich :-) Es gibt wieder verschiedene Möglichkeiten, 
