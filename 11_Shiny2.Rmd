...
![](VIDEO) (ca. 15 Minuten) 
*Notiz an mich: Slide mit Beispielen bringen; kurz Server und UI erklären und erklären, wie sie zusammenhängen*
*ich erkläre es im Text unten nochmal, da es ein so wichtiger und zentraler Bestandteil einer ShinyApp ist*
...
```{r package prep shiny, exercise = TRUE}
...
![](daten/abbildungen/shiny_step1.png)
...
![](daten/abbildungen/shiny_step2.png)
