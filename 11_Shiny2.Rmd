...
1. Wählt Euch eine Visualisierung (z.B. mit `ggplot2` oder aber auch mit `echarts4r`)  mit euren Daten aus (idealerweise habt Ihr schon Code, den Ihr jetzt einfach wieder benutzen könnt - zum Beispiel aus der letzten Woche. Wenn Ihr keinen Code bereit habt, haben wir etwas für Euch vorbereitet **TODO: MUSS NOCH GEMACHT WERDEN - app.R Datei erstellen und eine Visualisierung einbauen**)
