...
![](abbildungen/02_datenschutz-und-datenethik/personenbezogene-daten.png){#id .class width=100% height=100%}
```{r 02_quiz2}
quiz(caption = NULL,
...
![](abbildungen/02_datenschutz-und-datenethik/rechtmaessigkeit.png){#id .class width=100% height=100%}
...
![](abbildungen/02_datenschutz-und-datenethik/betroffenenrechte.png){#id .class width=100% height=100%}
...
![](abbildungen/02_datenschutz-und-datenethik/datenschutzerklaerung.png){#id .class width=100% height=100%}
...
![](abbildungen/02_datenschutz-und-datenethik/ethische-fragen.png){#id .class width=100% height=100%}
