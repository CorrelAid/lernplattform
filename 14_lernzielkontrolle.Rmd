...
*Tipp: Der Datensatz ist sehr messy. Die Events und Volunteers stehen in jeder Zeile (und sind damit Duplikate). Schaut Euch mal an, ob die Funktion `dplyr::distics()` zu der Herausforderung passt.*
