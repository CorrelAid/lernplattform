...
### Effekt
Insgesamt wurden auf den **`r sum(community$n_events)` Events** mit durchschnittlich **`r as.integer(round(mean(community$n_volunteers),0))` Freiwilligen** `r round(mean(community$n_pieces),2)` Plastikstücke gesammelt. Das entspricht **`r as.integer(sum(community$n_pieces))` Plastikstücken**. 
