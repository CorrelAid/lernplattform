...
Falls das Datenladen oder die Datenbereinigung bei Euch zu Problemen führt könnt Ihr die bereinigten Datensätze hiermit direkt laden:

```{r alternativesladen}
# Community Datensatz erstellen
community<-rio::import('https://raw.githubusercontent.com/CorrelAid/lernplattform/main/daten/community_perspective.csv')

# Audit Plastik Datensatz erstellen
audit_plastic<- rio::import('https://raw.githubusercontent.com/CorrelAid/lernplattform/main/daten/audit_perspective.csv')
...
```{r}
ggplot(data = audit_plastic, aes(x= continent, y= grand_total)) +
    geom_point(position = position_jitter(width = 0.3),
             size = 3,
             alpha = 0.6)  # Hinzufügen der Datenpunkte (Scatterplot) inkl. Stylingoptionen zur Positionierung, Punktegröße und Transparenz
...
ggplot(data = audit_plastic, aes(continent, grand_total)) + # Initialisierung des ggplots mit Variablen
  ...
  labs(
    title = "Gesammelte Plastikstücke bei 'Break Free From Plastic' ..." ,
    subtitle = "... unterscheidet sich nach Kontinent.",
