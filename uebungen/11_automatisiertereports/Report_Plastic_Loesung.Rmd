...
```{r wrangle-data-subset-continent, eval= params$filter_country != "alle Länder", include=FALSE}
audit_country <- audit %>%
  # Kontinent filtern
  dplyr::filter(country == params$filter_country)
...
##### Auswertung für `r params$filter_country`
