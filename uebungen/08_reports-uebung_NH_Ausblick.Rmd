...
### Aktivitäten
Help: Bestimmte Hersteller werden ausgeschlossen (siehe The Coca-Cola Company)
...
top10_parentcompany <- plastics19_by_country_and_company %>%
  ...
  dplyr::summarise(total_pieces = sum(n_pieces)) %>%
...
### Ausblick
Für die Zukunft bedeutet das: Mehr Mobilisierung und Aufbau lokaler Gruppen. Mit mehr Menschen können näämlich auch mehr Plastikstücke gesammelt werden (Korrelation: `r cor(community19_by_country$n_volunteers, community19_by_country$n_pieces)`). 
