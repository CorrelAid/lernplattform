...
ggplot(data = community19_by_country, aes(n_volunteers, n_pieces)) + # Initialisierung des ggplots mit Variablen
  geom_point(position = position_jitter(seed = 1, width = .2), size = 3, alpha = 0.5, color = "darkgrey") + # Hinzufügen der Datenpunkte (Scatterplot) inkl. Stylingoptionen zur Positionierung, Punktegröße, Transparenz und Farbe
