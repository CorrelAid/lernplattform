...
params:
  ...
  kontinent: 
    ...
    input: select
    choices: ["Americas", "Asia", "Africa", "Europe", "Oceania", "Unknown" ]
---
...
dplyr::glimpse(wb_protectedareas)
dplyr::glimpse(sdg_daten1251_clean)
```
...
### Wirkung
Insgesamt wurden auf den `r sum(community$num_events)` Events mit durchschnittlich `r round(mean(community$volunteers),0)` Freiwilligen `r round(mean(community$grand_total),0)` Plastikstücke gesammelt. Das entspricht `r as.integer(sum(community$grand_total))` Plastikstücken. 
