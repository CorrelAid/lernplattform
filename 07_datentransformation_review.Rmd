...
Den Datensatz `wb_areas` wollt Ihr nun mit dem Datensatz `plastics_processed` zusammenfügen. Um die Datensätze zusammenzuführen, braucht Ihr eine **gemeinsame Variable**, anhand der R die Länder einander zuordnen kann. Die Variable muss den **gleichen Namen** in beiden Datensätzen haben und die Kodierung (hier ISO2C) muss übereinstimmen. Da Ländernamen oft unterschiedlich genutzt werden, fokussieren wir uns auf die **Country Codes**:
