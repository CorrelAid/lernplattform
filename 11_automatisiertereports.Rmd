...
Druckt hier den als Parameter definierten Filter für Plastikart.
...
# Filtern des PlasticsPrep-Datensatzes für die Plastikart "hdpe"
audit %>%
  dplyr::filter(plastic_type == params$filter_plastic)
```

```{r 11quiz_2-parameter_filter, exercise = TRUE}
# Filtern des PlasticsPrep-Datensatzes für die Plastikart "hdpe" und Kontinent
audit %>%
  dplyr::filter(plastic_type == params$filter_plastic) 
# Euer Code hier
```

```{r 11quiz_2-parameter_filter-solution}
# Filtern des PlasticsPrep-Datensatzes für die Plastikart "hdpe" und Kontinent
audit %>%
  dplyr::filter(plastic_type == params$filter_plastic) %>%
