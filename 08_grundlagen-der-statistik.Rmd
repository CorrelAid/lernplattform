...
<center>
![*Grafik: Population und Stichprobe, Quelle: <https://systats.github.io/linear_model/basics.html>*](https://systats.github.io/linear_model/images/pop/population.png){#id .class width=70% height=70%}
...
<center>
![*Grafik: Grundbegriffe für den Umgang mit tabellarischen Datensätzen.<br>Quelle: Autor.*](https://github.com/CorrelAid/lernplattform/blob/michael_statistik/abbildungen/08_grundlagen-der-statistik/Datensatz.png?raw=true){#id .class width=100%}
</center>
...
<center>
![*Grafik: Schiefe vs. symmetrische Verteilungen. Quelle: Autor*](https://github.com/CorrelAid/lernplattform/blob/michael_statistik/abbildungen/08_grundlagen-der-statistik/Schiefe_Verteilungen.png?raw=true){#id .class width=100%}
</center>
...
<center>
![*Grafik: Bestimmung und Bedeutung von p-Quantilen. Quelle: Autor*](https://github.com/CorrelAid/lernplattform/blob/michael_statistik/abbildungen/08_grundlagen-der-statistik/Quantile.png?raw=true){#id .class width=100%}
</center>
...
<center>
![*Grafik: US-Bundesstaaten mit der niedrigsten (türkis) sowie der höchsten (rot) Nierenkrebsrate. Quelle: Wainer, H. ([2007](http://nsmn1.uh.edu/dgraur/niv/TheMostDangerousEquation.pdf))*](https://github.com/CorrelAid/lernplattform/blob/michael_statistik/abbildungen/08_grundlagen-der-statistik/kidney_cancer_map.png?raw=true){#id .class width=100%}
</center>
