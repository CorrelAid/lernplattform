...
```{r 02_quiz3}
quiz(caption = NULL,
 question("Darfst Du im Verein die Mitgliederdatenbank nutzen, um Monitoringdashboards und Prognosemodelle für die Vereinsentwicklung zu erstellen? Wenn ja, was ist die zugehrige Rechtsgrundlage?",
...
![](images/02dsgvo/ethische-fragen.png){#id .class width=100% height=100%}
...
# Eine Liste kann aus verschiedenen Datenformaten bestehen: hier werden das Wort 'Text', die Zahl 20 und das aktuelle Datum in eine Liste geschrieben, der Pfeil weist das dem Objekt mit dem Namen 'liste' zu
