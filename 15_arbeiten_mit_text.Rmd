...
Als weiteres Beispiel zur praktischen Anwendung schauen wir uns Kraft Foods an. Hierfür gibt es folgende Varianten, die einheitlich mit dem Namen `Kraft Foods` ersetzt werden sollen:
