...
**Robustheit** = Unsensibilität gegenüber *Ausreißern*
...
`library(dplyr)` - Package zur Datenbereinigung und Berechnung statistischer Kennzahlen
`library(ggplot2)` - Package zur Visualisierung von Daten
