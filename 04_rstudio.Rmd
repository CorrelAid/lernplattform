...
quiz(caption = NULL,
  question("RStudio ist eine integrierte Entwicklungsumgebung für R.",
  ...
  question("Dateiformate in RStudio sind unter anderem...",
    answer("R Markdowns zur Erstellung von PDF- und HTML-Reporten.", correct = TRUE),
...
### Übung
*Hinweis: In den folgenden Übungslektionen gibt es einen Teil, den Ihr innerhalb der Lernplattform erledigen könnt. Den anderen Teil solltet Ihr lokal auf Eurem Rechner ausführen, um Euch an die IDE RStudio zu gewöhnen. Wer weiß noch, wofür IDE steht?*
...
plastics <- plastics <- readr::read_csv('https://raw.githubusercontent.com/rfordatascience/tidytuesday/master/data/2021/2021-01-26/plastics.csv')
