...
- Mit **Knit** "strickt" Ihr aus einem RMD ein Outputdokument, während Ihr mit Run Code intepretieren lasst 
...
Falls Code nur unter bestimmten Bedingungen ausgeführt werden soll, wird er in **Wenn-Dann-Bedingungen** integriert. Dazu sind logische Ausdrücke sehr hilfreich. Welcher Text wird hier gedruckt?
...
Wenn Ihr einzelne Spalten oder **Subsets** (zu dt. Teilmengen) eines Datensatzes braucht, könnt Ihr diese aus dem Datensatz herausziehen.
