...
Beobachtungen und Variablen werden in **Objekten** zusammengefasst. Wir stellen Euch hier zwei wichtige Objekte vor: Listen und Dataframes (zu dt. Datenrahmen, ein tabellarisches Format). Mit was für einem Objekt Ihr arbeitet, könnt Ihr mit **class()** überprüfen. Testet die Funktion in Zeile 7 für Dataframes und führt den Code aus.
...
# In Euren Dataframes werden Daten in tabellarischen Formaten gespeichert. Spalten sollten dabei nur ein Datenformat enthalten (Ausnahme: fehlende Werte, die mit "NA" gekennzeichnet werden)
df <- data.frame("Variable1" = 1, "Variable2" = "Text")
# Euer Code hier
print(df)
```
