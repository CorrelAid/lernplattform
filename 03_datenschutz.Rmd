...
# In Euren Dataframes werden Daten in tabellarischen Formaten gespeichert 
# (wie in einer Excel Tabelle). Jede Spalte kann dabei nur Werte des gleichen 
# Datentyps enthalten (Ausnahme: fehlende Werte, die mit "NA" gekennzeichnet werden)
df <- data.frame(
  Variable1_numerisch = c(1, 2, 3), # c() erstellt eine Spalte im Data Frame
  Variable2_string = c("Text", "noch mehr Text", NA)
) # der letzte Wert von Variable2 fehlt
