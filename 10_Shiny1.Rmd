...
<!-- Notiz: Der Test muss noch gefüllt werden :) Ich weiß noch nicht genau, was ich als Antowrtkategorien möchte -->
```{r 10visualisierung}
quiz(caption = NULL,
...
<!-- Wenn wir die Bezeichnung in der Kurzinfo weiter anpassen möchten, können wir das über eine Kombination aus `dplyr` und `echarts4r` machen. Aktuell steht in der Kurzinfo noch volunteers - das können wir einfach in `Freiwillige` ändern: -->

<!-- ```{r karte_tooltip_advanced, eval=TRUE} -->

<!-- var_label(iris) <- list(volunteers = "Freiwillige", Petal.Width = "Width of Petal") -->

<!-- community %>%  -->
<!--   dplyr::rename(Freiwillige = volunteers) %>%  -->
<!--   echarts4r::e_charts(country) %>%  -->
<!--   echarts4r::e_map(Freiwillige) %>%  -->
<!--   echarts4r::e_visual_map(Freiwillige) %>%  -->
<!--   echarts4r::e_tooltip(trigger = "item") -->
<!-- ``` -->
