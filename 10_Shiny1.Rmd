...
Erinnert Ihr Euch noch an Eure Visualisierung aus der 5. Sitzung? Wie das funktioniert könnt Ihr noch einmal schön an dieser Visualisierung sehen:
...
histogram_plot <- ggplot2::ggplot(data = community, aes(x = volunteers)) +
  geom_histogram()
