...
**An Nina: Ich bin nicht sicher, ob das abgebildet werden kann. Falls nicht, würde ich ein Screen video davon machen und es kurz zeigen**

```{r karte_basic, eval=TRUE}
...
```{r ggsave, eval = FALSE, include=TRUE}
...
Dieser Befehl erlaubt es Euch, statische Visualisierungen zu speichern. Für interaktive Visualisierungen wie beispielsweise die durch `leaflet` erstellen Karten, bieten sich andere Formate wie `.html` oder aber auch eine ShinyApp an -- mehr dazu erfahrt Ihr nächste Woche!
