...
![](https://github.com/CorrelAid/lernplattform/blob/main/abbildungen/06_datentransformation/filter.png?raw=true){#id .class width=100% height=100%}
...
![](https://github.com/CorrelAid/lernplattform/blob/main/abbildungen/06_datentransformation/mutate.png?raw=true){#id .class width=100% height=100%}
...
![](https://github.com/CorrelAid/lernplattform/blob/main/abbildungen/06_datentransformation/groupby.png?raw=true){#id .class width=100% height=100%}
![](https://github.com/CorrelAid/lernplattform/blob/main/abbildungen/06_datentransformation/summarize.png?raw=true){#id .class width=100% height=100%}
...
![](https://github.com/CorrelAid/lernplattform/blob/main/abbildungen/06_datentransformation/select.png?raw=true){#id .class width=100% height=100%}
...
![](https://github.com/CorrelAid/lernplattform/blob/main/abbildungen/06_datentransformation/arrange.png?raw=true){#id .class width=100% height=100%}
