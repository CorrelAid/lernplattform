...
Kleine Anmerkung: Wie Euch bestimmt aufgefallen ist, sind die Jahreszahlen beim Filtern in Anführungszeichen geschrieben. Hier kommt es auf den Datentyp an, ob Ihr Anführungszeichen braucht oder nicht - in diesem Fall ist die Variable `plastics$year` sogar numerisch, die Anführungszeichen damit gar nicht notwendig. Hier aber dafür noch eine kleine Übersicht über die Datentypen, die es in R gibt: 
