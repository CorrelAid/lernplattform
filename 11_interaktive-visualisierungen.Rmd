...
<center>
![](https://github.com/CorrelAid/lernplattform/blob/main/abbildungen/app-server.png?raw=true){#id .class width=70% height=70%}
</center>
...
![](https://github.com/CorrelAid/lernplattform/blob/main/abbildungen/11_interaktive_visualisierungen/shiny_step2.png?raw=true){#id .class width=50% height=50%}
