...
![](https://github.com/CorrelAid/lernplattform/blob/main/abbildungen/david.jpg?raw=true){#id .class width=180% height=100%}
  ...
  <p style="margin-left: 100px;">
[David]((mailto:education@correlaid.org)) promoviert an der Uni Mannheim im Bereich Politikwissenschaft. Mit seiner Leidenschaft für “data4good” unterstützt er CorrelAid ehrenamtlich.
  </p>
  </div>
</div>
