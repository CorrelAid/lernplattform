...
knitr::include_graphics("abbildungen/zoe.jpg")
```
</div>
  <div class="col-sm-10">
...
```{r echo=FALSE, out.width="200px"} 
knitr::include_graphics("abbildungen/frie.jpg")
```
  </div>
  <div class="col-sm-10">
...
<div class="row">
  <div class="col-sm-2">
<h4 style="visibility: hidden;">Lisa</h4>
```{r echo=FALSE, out.width="200px"} 
knitr::include_graphics("abbildungen/lisa.jpg")
```
</div>
  <div class="col-sm-10">
...
<div class="row">
  <div class="col-sm-2">
<h4 style="visibility: hidden;">Sylvi</h4>
```{r echo=FALSE, out.width="200px"} 
knitr::include_graphics("abbildungen/sylvi.jpg")
```
</div>
  <div class="col-sm-10">
...
```{r echo=FALSE, out.width="200px"}
knitr::include_graphics("abbildungen/nina.png")
```
</div>
  <div class="col-sm-10">
...
<div class="row">
  <div class="col-sm-2">
<h4 style="visibility: hidden;">Cosima</h4>
```{r echo=FALSE, out.width="200px"} 
knitr::include_graphics("abbildungen/cosima.png")
```
</div>
  <div class="col-sm-10">
...
```{r echo=FALSE, out.width="200px"} 
knitr::include_graphics("abbildungen/phil.jpg")
```
</div>
  <div class="col-sm-10">
