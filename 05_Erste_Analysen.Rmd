...
- Sie ist nützlich, um von einer Umfrage auf die Grundgesamtheit zu schließen oder für die Evaluation von Maßnahmen, um wirklich Änderungen von statistischen Artefakten unterscheiden zu können. 
...
Zur Interpretation: Wir können unsere Hypothese nicht verwerfen. Darauf deutet die niedrige t-Statistik, der p-Wert jenseits von .10 und das Konfidenzintervall, das die 0 umschließt, hin. In unserem Beispiel bedeutet dies, dass sich die Anzahl an Plastikarten in Europa nicht systematisch von denen in Asien unterscheidet. Zumindest können wir keinen robusten statistischen Unterschied feststellen.       
...
``` {r mogl_lsg_kennzahl, echo=FALSE}
