...
ggplot(community, aes(continent, volunteers))
```


```{r grahik2, echo=FALSE}
ggplot(community, aes(volunteers, continent)) +
  geom_bar(stat="identity")
```


```{r grahik3, echo=FALSE}
ggplot(community, aes(volunteers, reorder(continent, volunteers))) +
...
ggplot(community, aes(reorder(continent, volunteers),volunteers)) +
