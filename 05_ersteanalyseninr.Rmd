...
Lasst uns Asien etwas genauer ansehen und die Verteilung von Plastikstücken, die in asiatischen Ländern gesammelt wurden näher kennenlernen.
...
asien_plot +
  ...
  geom_point(
    ...
    # sd
  geom_linerange(
    aes(xmin=n_pieces_mean-n_pieces_sd/2, xmax=n_pieces_mean+n_pieces_sd/2),
    size=2,
    color = "red",
  ) 
```
