...
Es gibt noch viele weitere Quantile. Besonders häufig kommen noch das 25%-Quantil und das 75%-Quantil zum Einsatz. 

!?CONTINUE HERE
vielleicht im Quiz das 25% und 75 quantile erfragen? Vielleicht in den Graphen noch Beschriftung hinzufügen für genau diese Länder 

Dann zum Boxplot übergehen
q25 - Japan 
q50 - China
q75 - Malaysia
```{r q25_q75_einfärben}
...
Nächstes To Do zu den Graphen ein Begleittext schreiben und ein paar Quizfragen einstellen
Ziel: nach dem wir den Graphen für ein Land entpackt haben können wir die für alle Länder auch interpretieren 
