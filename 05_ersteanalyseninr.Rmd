...
### Quiz
Frie: die Fragen hier sind unten in den abschnitten z.T. gedoppelt. ist das absicht? wenn ja, sinnvoll?
...
quiz(caption = NULL,
  ...
  question("Was sind alles Lagemaße einer Verteilung?",
    ...
    correct = "Richtig!",
    incorrect = "Leider falsch: Mit Maximum und Minimum berechnen wir lediglich die Spannweite, die selbst ein Streuungsparameter ist.",
    allow_retry = TRUE,
    try_again_button = "Nochmal versuchen"
  ),
...
Frie: hier würde ich bei frage zwei einen Hinweis/reminder einfügen was die Spannweite ist (ich habe ausserdem mal "spannbreite" (was z.t. auch verwendet wird) durch Spannweite ersetzt was der richtige Begriff zu sein scheint laut google)
...
Frie: ggf verschieben in Grundlagen der statistik.. ist schon sehr lang alles. :( 
...
Nina: hier der Plot
Sylvi: lass uns den gern zeigen - ich würde aber vorschlagen, die Trendlinie mit einem alpha zu belegen, so dass sie den Graphen nicht zu sehr überlagert. - Habe das im Graphen direkt implementiert, was sagst du dazu?
Nina: find ich super
...
Frie: hiermit bin ich noch nicht so happy. sorry. vlt beispiel wieso es auch andersrum kausal sein könnte? zb. sind in ländern mit besonders viel plastikstücken (und somit höherem "sammelpotential") die leute motivierter? oder Landesgröße als cofounding variable. 

0.81 bestätigt, dass wir einen positiven und recht starken statischen Zusammenhang zwischen der Anzahl an Plastikstücken und Freiwilligen auf Länderebene beobachten. Beachtet, der Korrelationskoeffizient bietet keinerlei Möglichkeit einer kausalen Aussage. Weder unser Diagramm noch der Koeffizient lassen den Schluss zu, dass alleinig mehr Freiwillige zu mehr gesammelten Plastikstücken führen. Außerdem muss auch hier wieder beachtet werden, dass die Aussage nur auf Länderebene getroffen werden kann: es kann nicht geschlossen werden, dass Events mit mehr Freiwilligen mehr Plastikstücke sammeln.
...
Frie: was wir ganz vergessen haben: manche länder sind auch einfach groesser als andere?? die daten sind ja nicht normiert. 
