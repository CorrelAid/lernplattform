...
<center>![Bild: Evidenzklassen](https://correlaid.org/material/evidenzklassen.png){#id .class width="100%" height="100%"}</center>
...
Stehe einmal kurz vom Computer auf und schau aus dem Fenster. Ist die Straße draußen nass? Wenn die Straße trocken ist, folgt daraus, dass es nicht geregnet hat. Es folgt aber andersherum nicht, dass es geregnet haben muss, wenn die Straße nass ist. Es hätte ja jemand auch die Straße mit einem Gartenschlauch gießen können. Intuitiv werden wir aber annehmen, dass die Beobachtung einer nassen Straße die Aussage "es hat geregnet" *plausibler* macht. Statistik ist am Ende nichts anderes als eine Systematisierung dieser Art von Plausibilisierungen. Wir haben Beobachtungen ("die Straße draußen ist naß"), auch Daten genannt, mit denen wir etwas über die Plausibilität einer Hypothese ("es hat geregnet") oder eines Modelles lernen wollen.
...
quiz(caption = NULL,
  ...
  question("Nimm an, dass du während deines letzten Arztbesuches positiv auf eine seltene Krankheit getestet wurdest. Wenn du der Ärztin nur eine Frage stellen darfst, welche wäre das?",
    ...
    correct = "Antworten gemerkt? Dann weiter zur Auflösung im Text.",
    type="learnr_radio"
    )
  )
```
...
-   [Pepsi, Coca Cola und die Geschichte der Nullhypothese](https://correlaid.org/blog/pepsi/){target="_blank"}, Manuel Neumann im CorrelAid Blog, 2019
-   [About P-Values](https://correlaid.org/blog/understand-p-values/){target="_blank"}, Daniel Lakens im CorrelAid Blog, 2017
