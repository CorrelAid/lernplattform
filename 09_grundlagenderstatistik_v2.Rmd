...
# Berechne nun die posterior Wahrscheinlichkeit. Nutze dazu die oben gegebenen Informationen.
p_posterior_krank <- (rpr * p_prior) / ((rpr * p_prior) + (fpr * (1 - p_prior)))
...
Nun seid ihr aber an der Reihe! Versucht doch einmal im Beispiel oben eine Irrtumswahrscheinlichkeit von unter 5% zu erreichen. Dafür muss euer z-Wert größer/kleiner als $1,960$/$-1,960$ sein. Nutzt einfach den Code oben und ändert die Differenz zwischen den Anteilen der Differenzen oder auch die Stichprobengröße. Was fällt Euch zum Beispiel bei der Stichprobengröße auf?
