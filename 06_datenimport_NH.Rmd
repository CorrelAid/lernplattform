...
# Einlesen des Shapefiles (geometrischen Datensatzes, erkennbar an .shp) über sf::st_read()
polygons_welt <- sf::st_read(here::here("daten/geospatial/world_50m_countries.shp"))
```
...
polygon_deutschland <- sf::st_read(here::here("daten/geospatial/1000_NUTS1.shp"))
plot(polygon_deutschland$geometry)
```
...
### APIs
Friee
https://app.dataquest.io/course/apis-in-r
