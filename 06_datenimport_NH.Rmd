...
quiz(caption = NULL,
  ...
  question("Welche Faktoren spielen beim Datenimport eine wichtige Rolle?",
    ...
    answer("Die Art und Weise wie die Daten reladen werden sollen (einmalig, periodisch oder live)", correct = TRUE),
    correct = "Richtig!",
  ...
  question("An welcher Dateiendung erkennt Ihr Excel-Dateien?",
    ...
    answer("CSV"),
    correct = "Richtig!",
    incorrect = "Leider falsch: CSV-Dateien sind Textdateien.",
    allow_retry = TRUE,
    try_again_button = "Nochmal versuchen",
    random_answer_order = TRUE
  ),
  ...
  question("Welche Optionen habt Ihr lokale Dateien zu importieren?",
    ...
    answer("Mit individuellen Funktionen für die verschiedenen Dateiformate", correct = TRUE),
    correct = "Richtig!",
  ...
  question("Können nur lokale Dateien geladen werden?",
    answer("Ja"),
  ...
  question("Um Datenquellen live zu verknüpfen, ist es notwendig, selbst eine  ",
    answer("Es ist nicht best practice."),
    answer("Es ist leichter technisch umzusetzen."),
    answer("Es garantiert, dass Daten aktuell und damit qualitativ hochwertiger sind.", correct = TRUE),
    correct = "Richtig! Entscheidungen trefft Ihr damit auf Basis von aktuellen (und nicht eventuall auf der Basis von veralteten) Daten.",
...
2. Ladet den "Plastics"-Datensatz über einen **Hyperlink** [Link](https://raw.githubusercontent.com/rfordatascience/tidytuesday/master/data/2021/2021-01-26/plastics.csv){target="_blank"}.
